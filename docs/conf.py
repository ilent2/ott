...
master_doc = 'index'
latex_master = 'documentation_toc'
...
latex_documents = [
    (latex_master, 'OTT.tex', u'OTT Documentation',
...
man_pages = [
    (master_doc, 'ott', u'OTT Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OTT', u'OTT Documentation',
     author, 'OTT', 'One line description of project.',
     'Miscellaneous'),
]
