...
function testConstructDefault(testCase)
  ...
  testCase.verifyEqual(beam.radial_mode, 0, 'azimuthal_mode');
  testCase.verifyEqual(beam.azimuthal_mode, 0, 'radial_mode');
...
function testConstructDefault(testCase)
  ...
  testCase.verifyEqual(beam.azimuthal_mode, azimuthal_mode, 'azimuthal_mode');
  testCase.verifyEqual(beam.radial_mode, radial_mode, 'radial_mode');
...
function testModeErrors(testCase)
  ...
  import ott.beam.vswf.LaguerreGaussian;
  waist = 1.0;
