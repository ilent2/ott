classdef IncoherentArrayType < ott.beam.properties.ArrayType
% Declares a constant array_type property for incoherent array types.
%
...
%
% Properties
%   - array_type      -- Constant, 'incoherent'
