classdef AxisymStarShape < ott.shapes.mixin.StarShape ...
...
% See LICENSE.md for information about using/distributing this file.
  ...
  methods (Hidden)
    function nxyz = normalsXyzInternal(varargin)
      nxyz = normalsXyzInternal@ott.shapes.mixin.AxisymShape(varargin{:});
    end
    ...
    function b = insideRtpInternal(varargin)
      b = insideRtpInternal@ott.shapes.mixin.StarShape(varargin{:});
    end
    function b = insideXyzInternal(varargin)
      b = insideXyzInternal@ott.shapes.mixin.AxisymShape(varargin{:});
    end
  end
end
