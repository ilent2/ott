...
% using/distributing this file.
  ...
  properties (Constant)
    ...
    helpText = {ott.ui.drag.Simple.aboutText, ...
      '', ...
      'output - Variable name for generated drag tensor.', ...
      '', ...
      ['shape - Variable name of shape to attempt to generate drag tensor', ...
      ' for.  May not work for all shapes, if there is a problem, a warning', ...
      ' or error will be displayed in the command window.'], ...
      '', ...
      'viscosity - Specify the viscosity (kg m s)', ...
      '', ...
      ['The table displays a preview of the drag tensor.  This can be useful', ...
      ' to inspect the output for errors/nans.']};
