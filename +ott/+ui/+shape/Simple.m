...
%   the pill height changes.
  ...
  properties (Constant)
    ...
    helpText = {ott.ui.shape.Simple.aboutText, ...
      ...
      '   - Biconcave Disc (radius, 3-coefficients)', ...
      '', ...
      'Output - Specify the output variable name for the generated shape.', ...
      '', ...
      ['ShowPreview - If selected, a preview of the shape is displayed', ...
      ' in the axis.  If the shape is complex, you may wish to disable this.'], ...
      '', ...
      ['Local view - This option changes the shap visualisation in the axis', ...
      ' to either include rotation/offset or ignore these when drawing.']};
  ...
  methods (Access=protected)
    ...
    function data = generateData(app)
      ...
      offset = app.OffsetXyzSpinners.Value(:);
