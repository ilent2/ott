...
% TODO: Add support for input arguments to class
  ...
  properties (Constant)
    ...
    helpText = {ott.ui.tools.PowerSpectrum.aboutText, ...
      '', ...
      'Time data - An array of evenly spaced points describing the time ', ...
      'corresponding to each position value.', ...
      '', ...
      'Value data - The position (or rotation) of the particle.  Must ', ...
      'be an array with the same size as the time data array.', ...
      '', ...
      'Label entries - These can be used to modify the labels in the plot.', ...
      '', ...
      'By default, the window will attempt to update the plot whenever the ', ...
      'inputs change.  If there is an error, it will be displayed in the ', ...
      'matlab console.'};
