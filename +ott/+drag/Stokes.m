...
%   - ott.shapes.Shape  -- Gets a geometrical representation of the object
%
...
% See LICENSE.md for information about using/distributing this file.
  ...
  methods (Static)
    function drag = FromShape(shape, varargin)
      ...
      elseif numel(shape) == 2 && ( isa(shape(1), 'ott.shapes.Plane') ...
          || isa(shape(2), 'ott.shapes.Plane'))
      ...
      elseif numel(shape) == 2 && ...
        ...
        if ~isa(inner, 'ott.shapes.Sphere')
          warning('ott:drag:Stokes:approx_as_sphere', ...
            'Approximating particle shape as sphere');
        end

        if ~isa(outer, 'ott.shapes.Sphere')
