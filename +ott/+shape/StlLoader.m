classdef StlLoader < ott.shape.TriangularMesh
...
% See LICENSE.md for information about using/distributing this file.
  ...
  methods
    function obj = StlLoader(filename, varargin)
      ...
      [faces,verts,~] = ott.shape.StlLoader.stlbinary(M);
      ...
      % Setup object
      obj = obj@ott.shape.TriangularMesh(uverts.', faces.', varargin{:});
