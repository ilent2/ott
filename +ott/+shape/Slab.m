...
% See LICENSE.md for information about using/distributing this file.
  ...
  methods
    ...
    function shape = ott.shape.PatchMesh(shape, varargin)
      ...
      shape = ott.shape.Strata(shape, unmatched{:});
      shape = ott.shape.PatchMesh(shape, 'scale', p.Results.scale);
    end

    function shape = ott.shape.Strata(shape, varargin)
      % Can be cast to a Strata

      shape = ott.shape.Strata('normal', shape.normal, ...
          'depths', shape.depth, ...
